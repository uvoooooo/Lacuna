...
把一段叙述拆成 **说了什么 / 暗示了什么 / 没说什么 / 证据够不够**——不判断谁对谁错。

多 agent + shared state 的流水线：从原文抽取原子陈述，打标签，找出结构性留白，只对可核查事实去找证据，最后给出校准置信度与可读报告。

> 核心理念（见 [`proposal.md`](docs/proposal.md)）：不要只听他说了什么，更要注意整幅图里缺了什么。
...
Input 文本
  ...
  ↓  MissingContext   缺什么(起因/证据/时间地点/第三方/反方/后续) + 该追问什么
